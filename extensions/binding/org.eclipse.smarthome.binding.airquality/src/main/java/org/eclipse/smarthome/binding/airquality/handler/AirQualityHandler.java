 ...
 */
package org.eclipse.smarthome.binding.airquality.handler;

import static org.eclipse.smarthome.binding.airquality.AirQualityBindingConstants.AQI;
...
public class AirQualityHandler extends BaseThingHandler {
    ...
    public void handleCommand(ChannelUID channelUID, Command command) {
        if (channelUID.getId().equals(AQI)) {
            // TODO: handle command
